...
const HotelSettingsPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setIsLoading(true);
                const [settingsResponse, currenciesResponse, rolesResponse] = await Promise.all([
                    getHotelSettings(),
                ...
                setFormData({
                    ...
                    housekeepingRoleId: settingsResponse.data.housekeepingRole?.id || null,
                });
            } catch (error: any) {
    ...
    const handleInputChange = (field: keyof UpdateHotelSettingsRequest, value: any) => {
        setFormData(prev => ({
            ...prev,
            [field]: value
        }));
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="housekeepingRole" className="text-sm font-medium">
                                        Housekeeping Role
                                    </Label>
                                    <Select
                                        ...
                                        onValueChange={(value) => {
                                            if (value === 'none') {
                                                ...
                                                handleInputChange('housekeepingRoleId', value);
                                            }
                                        }}
                                    >
                                        <SelectTrigger className='w-full'>
                                            <SelectValue placeholder="Select role to assign housekeeping tasks to" />
                                        </SelectTrigger>
                                        <SelectContent>
                        ...
                        {settings && (
                            <div className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                                    <div>
                                        <span className="text-gray-600">Housekeeping Role:</span>
                                        <p className="font-medium">{settings.housekeepingRole ? settings.housekeepingRole.name : 'Not set'}</p>
                                    </div>
                                    <div>
